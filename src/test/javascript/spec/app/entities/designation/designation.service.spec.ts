    ...
    describe('Designation Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/designations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Designation', () => {
                service.create(new Designation(null)).subscribe(received => {
            ...
            it('should update a Designation', () => {
                service.update(new Designation(123)).subscribe(received => {
            ...
            it('should return a Designation', () => {
